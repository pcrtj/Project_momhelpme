...
public class Home extends JPanel {
    private ImageIcon feild = new ImageIcon(this.getClass().getResource("img\\eezy_61-01.jpg"));
	private ImageIcon exit = new ImageIcon(this.getClass().getResource("img\\exit.png"));
	private ImageIcon starts = new ImageIcon(this.getClass().getResource("img\\start.png"));
